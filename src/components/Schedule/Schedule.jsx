...
import DateBloc from './DateBloc.js';
...
export default function Schedule() {
  ...
  return (
    ...
    <ScrollView>
      <DateBloc date={currentDate} onBackward={handleBackward} onForward={handleForward} />
      <View style={styles.container}>
        ...
        <View>
          <Text style={styles.update}>Останнє оновлення: {lastUpdateDate} | {lastUpdateTime}</Text>
        </View>
      </View>
  );
}
